...
# ---------------------------------------------------------
# Interactive Prediction Loop for ConvNeXt
# ---------------------------------------------------------
def interactive_prediction_loop(model_path, dataset_dir):
    ...
    # 2. Initialize ConvNeXt & Load Weights ONCE
    ...
    print("="*50)
    print("ConvNeXt INTERACTIVE PREDICTOR")
...
if __name__ == "__main__":
    # Path to your saved ConvNeXt weights
    MODEL_WEIGHTS = "../models/best_convnext_v2_model.pth"
